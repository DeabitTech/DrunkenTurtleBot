...
class Client(object):
    ...
    PUBLIC_API_VERSION = 'v3' # !!! if something is not working, pls restore it to v1
    ...
    def __init__(self,
        ...
        # self.ping() ### let's only use it for debugging
...
"""
    ...
    def cancel_all_open_orders(self, **params):
        return self._request_api('delete', 'openOrders', True, data=params)
